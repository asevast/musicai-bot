...
var lf = "Request parameters are invalid", kt = class extends $ {
    ...
    code = "P5011";
    constructor(r, t = lf) { super(t, R(r, !1)); }
};
...
var Dl = 3, $t = N("prisma:client:dataproxyEngine"), qt = class {
    ...
    startPromise;
    protocol;
    constructor(r) { Rl(r), this.config = r, this.env = r.env, this.inlineSchema = Sl(r.inlineSchema), this.inlineDatasources = r.inlineDatasources, this.inlineSchemaHash = r.inlineSchemaHash, this.clientVersion = r.clientVersion, this.engineHash = r.engineVersion, this.logEmitter = r.logEmitter, this.tracingHelper = r.tracingHelper; }
...
} let s = Er(r.generator), a = s === "library", l = s === "binary", u = s === "client", c = (i.accelerate || i.ppg) && !i.driverAdapters; return i.accelerate ? new qt(r) : (i.driverAdapters, a ? new Qr(r) : new Qr(r)); }
...
function fu(e) {
    class r {
        ...
        } let a = !s && o && st(o, { conflictCheck: "none" }) || e.injectableEdgeEnv?.(); try {
