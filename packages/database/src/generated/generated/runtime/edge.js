...
var Pn = Je((Mf, Ml) => { Ml.exports = { name: "@prisma/engines-version", version: "7.1.1-3.c2990dca591cba766e3b7ef5d9e8a84796e47ab7", main: "index.js", types: "index.d.ts", license: "Apache-2.0", author: "Tim Suchanek <suchanek@prisma.io>", prisma: { enginesVersion: "c2990dca591cba766e3b7ef5d9e8a84796e47ab7" }, repository: { type: "git", url: "https://github.com/prisma/engines-wrapper.git", directory: "packages/engines-version" }, devDependencies: { "@types/node": "18.19.76", typescript: "4.9.5" }, files: ["index.js", "index.d.ts"], scripts: { build: "tsc -d" } }; });
var Xi = Je(gr => {
    "use strict";
    f();
    u();
...
var Zn = "This request could not be understood by the server", Qt = class extends G {
    ...
    code = "P5000";
    constructor(t, r, n) { super(r || Zn, U(t, !1)), n && (this.code = n); }
};
...
var sp = "Request parameters are invalid", Zt = class extends G {
    ...
    code = "P5011";
    constructor(t, r = sp) { super(r, U(t, !1)); }
};
...
var ei = "Requested resource does not exist", Xt = class extends G {
    name = "NotFoundError";
    code = "P5003";
    constructor(t, r = ei) { super(r, U(t, !1)); }
};
N(Xt, "NotFoundError");
f();
u();
...
var ti = "Unknown server error", yt = class extends G {
    ...
    code = "P5006";
    logs;
    constructor(t, r, n) { super(r || ti, U(t, !0)), this.logs = n; }
};
N(yt, "ServerError");
f();
u();
...
var ri = "Unauthorized, check your connection string", er = class extends G {
    ...
    code = "P5007";
    constructor(t, r = ri) { super(r, U(t, !1)); }
};
...
var ni = "Usage exceeded, retry again later", tr = class extends G {
    ...
    code = "P5008";
    constructor(t, r = ni) { super(r, U(t, !0)); }
};
...
var Vs = 3, ir = z("prisma:client:dataproxyEngine"), Et = class {
    ...
    startPromise;
    protocol;
    constructor(t) { Ls(t), this.config = t, this.env = t.env, this.inlineSchema = Fs(t.inlineSchema), this.inlineDatasources = t.inlineDatasources, this.inlineSchemaHash = t.inlineSchemaHash, this.clientVersion = t.clientVersion, this.engineHash = t.engineVersion, this.logEmitter = t.logEmitter, this.tracingHelper = t.tracingHelper; }
...
} let s = Ze(t.generator), a = s === "library", l = s === "binary", d = s === "client", g = (i.accelerate || i.ppg) && !i.driverAdapters; return i.accelerate ? new Et(t) : (i.driverAdapters, new Et(t)); }
f();
u();
c();
p();
...
function ya(e) {
    class t {
        ...
        constructor(n) { e = n?.__internal?.configOverride?.(e) ?? e, Is(e), n && fa(n, e); let i = new Jr().on("error", () => { }); this._extensions = ct.empty(), this._previewFeatures = Gs(e), this._clientVersion = e.clientVersion ?? aa, this._activeProvider = e.activeProvider, this._globalOmit = n?.omit, this._tracingHelper = ta(); let o = e.relativeEnvPaths && { rootEnvPath: e.relativeEnvPaths.rootEnvPath && dr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && dr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) }, s; if (n?.adapter) {
            s = n.adapter;
